...
/**
 * ImMsgSendImMsgSendBody Class Doc Comment
 *
 * @category Class
 * @package  swagger_client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ImMsgSendImMsgSendBody implements ModelInterface, ArrayAccess
{
...
'media_id' => 'getMediaId'    ];
    ...
    const IM_MSG_SEND_IM_MSG_SEND_MESSAGE_TYPE_TEXT = 'text';
const IM_MSG_SEND_IM_MSG_SEND_MESSAGE_TYPE_IMAGE = 'image';
    ...
    {
        return [
            self::IM_MSG_SEND_IM_MSG_SEND_MESSAGE_TYPE_TEXT,
            self::IM_MSG_SEND_IM_MSG_SEND_MESSAGE_TYPE_IMAGE,''
        ];
    }
