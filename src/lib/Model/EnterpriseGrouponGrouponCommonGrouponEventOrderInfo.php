...
/**
 * EnterpriseGrouponGrouponCommonGrouponEventOrderInfo Class Doc Comment
 *
 * @category Class
 * @package  swagger_client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EnterpriseGrouponGrouponCommonGrouponEventOrderInfo implements ModelInterface, ArrayAccess
{
...
'pay_time' => 'int',
'refund_time' => 'int',
'codes' => '\swagger_client\Model\EnterpriseGrouponGrouponCommonGrouponEventCodeInfo[]'    ];
...
'codes' => 'getCodes'    ];
    ...
    const ENTERPRISE_GROUPON_GROUPON_COMMON_GROUPON_EVENT_STATUS_1 = 1;
const ENTERPRISE_GROUPON_GROUPON_COMMON_GROUPON_EVENT_STATUS_101 = 101;
const ENTERPRISE_GROUPON_GROUPON_COMMON_GROUPON_EVENT_STATUS_200 = 200;
const ENTERPRISE_GROUPON_GROUPON_COMMON_GROUPON_EVENT_STATUS_201 = 201;
const ENTERPRISE_GROUPON_GROUPON_COMMON_GROUPON_EVENT_STATUS_202 = 202;
const ENTERPRISE_GROUPON_GROUPON_COMMON_GROUPON_EVENT_STATUS_299 = 299;
const ENTERPRISE_GROUPON_GROUPON_COMMON_GROUPON_EVENT_STATUS_300 = 300;
const ENTERPRISE_GROUPON_GROUPON_COMMON_GROUPON_EVENT_STATUS_301 = 301;
const ENTERPRISE_GROUPON_GROUPON_COMMON_GROUPON_EVENT_STATUS_302 = 302;
    ...
    {
        return [
            self::ENTERPRISE_GROUPON_GROUPON_COMMON_GROUPON_EVENT_STATUS_1,
            self::ENTERPRISE_GROUPON_GROUPON_COMMON_GROUPON_EVENT_STATUS_101,
            self::ENTERPRISE_GROUPON_GROUPON_COMMON_GROUPON_EVENT_STATUS_200,
            self::ENTERPRISE_GROUPON_GROUPON_COMMON_GROUPON_EVENT_STATUS_201,
            self::ENTERPRISE_GROUPON_GROUPON_COMMON_GROUPON_EVENT_STATUS_202,
            self::ENTERPRISE_GROUPON_GROUPON_COMMON_GROUPON_EVENT_STATUS_299,
            self::ENTERPRISE_GROUPON_GROUPON_COMMON_GROUPON_EVENT_STATUS_300,
            self::ENTERPRISE_GROUPON_GROUPON_COMMON_GROUPON_EVENT_STATUS_301,
            self::ENTERPRISE_GROUPON_GROUPON_COMMON_GROUPON_EVENT_STATUS_302,''
        ];
    }
     ...
     * Gets codes
     *
     * @return \swagger_client\Model\EnterpriseGrouponGrouponCommonGrouponEventCodeInfo[]
     */
     ...
     * Sets codes
     *
     * @param \swagger_client\Model\EnterpriseGrouponGrouponCommonGrouponEventCodeInfo[] $codes 团购券码列表
     *
     * @return $this
     */
