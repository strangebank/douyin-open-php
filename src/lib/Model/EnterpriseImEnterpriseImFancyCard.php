...
/**
 * EnterpriseImEnterpriseImFancyCard Class Doc Comment
 *
 * @category Class
 * @package  swagger_client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EnterpriseImEnterpriseImFancyCard implements ModelInterface, ArrayAccess
{
     ...
     * Sets card_id
     *
     * @param string $card_id 动态卡片id（内测中）
     *
     * @return $this
     */
