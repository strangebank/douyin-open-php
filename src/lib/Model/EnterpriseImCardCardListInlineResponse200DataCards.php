...
/**
 * EnterpriseImCardCardListInlineResponse200DataCards Class Doc Comment
 *
 * @category Class
 * @package  swagger_client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EnterpriseImCardCardListInlineResponse200DataCards implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_data_cards';
...
'reject_reason' => 'getRejectReason'    ];
    ...
    const ENTERPRISE_IM_CARD_CARD_LIST_STATUS_AVALIABLE = 'avaliable';
const ENTERPRISE_IM_CARD_CARD_LIST_STATUS_REVIEW = 'review';
const ENTERPRISE_IM_CARD_CARD_LIST_STATUS_REJECT = 'reject';
    ...
    {
        return [
            self::ENTERPRISE_IM_CARD_CARD_LIST_STATUS_AVALIABLE,
            self::ENTERPRISE_IM_CARD_CARD_LIST_STATUS_REVIEW,
            self::ENTERPRISE_IM_CARD_CARD_LIST_STATUS_REJECT,''
        ];
    }
     ...
     * Sets reject_reason
     *
     * @param string $reject_reason 审核不通过理由
     *
     * @return $this
     */
