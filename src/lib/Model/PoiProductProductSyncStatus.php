...
/**
 * PoiProductProductSyncStatus Class Doc Comment
 *
 * @category Class
 * @description 数据同步结果
 * @package  swagger_client
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PoiProductProductSyncStatus implements ModelInterface, ArrayAccess
{
...
'fail_reason' => 'getFailReason'    ];
    ...
    const POI_PRODUCT_PRODUCT_LAST_SYNC_STATUS_0 = 0;
const POI_PRODUCT_PRODUCT_LAST_SYNC_STATUS_1 = 1;
const POI_PRODUCT_PRODUCT_LAST_SYNC_STATUS_2 = 2;
    ...
    {
        return [
            self::POI_PRODUCT_PRODUCT_LAST_SYNC_STATUS_0,
            self::POI_PRODUCT_PRODUCT_LAST_SYNC_STATUS_1,
            self::POI_PRODUCT_PRODUCT_LAST_SYNC_STATUS_2,''
        ];
    }
