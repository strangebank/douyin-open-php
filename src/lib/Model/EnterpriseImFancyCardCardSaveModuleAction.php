...
/**
 * EnterpriseImFancyCardCardSaveModuleAction Class Doc Comment
 *
 * @category Class
 * @package  swagger_client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EnterpriseImFancyCardCardSaveModuleAction implements ModelInterface, ArrayAccess
{
...
'url' => 'getUrl'    ];
    ...
    const ENTERPRISE_IM_FANCY_CARD_CARD_SAVE_ACTION_TYPE_API = 'api';
const ENTERPRISE_IM_FANCY_CARD_CARD_SAVE_ACTION_TYPE_H5 = 'h5';
const ENTERPRISE_IM_FANCY_CARD_CARD_SAVE_ACTION_TYPE_NATIVE = 'native';
const ENTERPRISE_IM_FANCY_CARD_CARD_SAVE_ACTION_TYPE_REACT_NATIVE = 'react-native';
    ...
    {
        return [
            self::ENTERPRISE_IM_FANCY_CARD_CARD_SAVE_ACTION_TYPE_API,
            self::ENTERPRISE_IM_FANCY_CARD_CARD_SAVE_ACTION_TYPE_H5,
            self::ENTERPRISE_IM_FANCY_CARD_CARD_SAVE_ACTION_TYPE_NATIVE,
            self::ENTERPRISE_IM_FANCY_CARD_CARD_SAVE_ACTION_TYPE_REACT_NATIVE,''
        ];
    }
