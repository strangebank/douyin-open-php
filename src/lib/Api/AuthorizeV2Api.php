...
class AuthorizeV2Api
{
     ...
     * @param  string $scope 填login_id (required)
     * @param  string $redirect_uri 授权成功后的回调地址，必须以http/https开头。域名要跟申请应用时填写的授权回调域一致。用于调用https://open.douyin.com/oauth/access_token/换token。 (required)
     * @param  string $state 用于保持请求和回调状态，授权请求后会原样返回给接入方,如果是App则不用传该参数 (optional)
     *
