...
class PoiOrderSyncApi
{
     ...
     * 订单同步
     *
     * @param  \swagger_client\Model\PoiOrderSyncOrderSyncBody $body body (required)
     ...
     * @return \swagger_client\Model\PoiOrderSyncOrderSyncInlineResponse200
     */
     ...
     * 订单同步
     *
     * @param  \swagger_client\Model\PoiOrderSyncOrderSyncBody $body (required)
     * @param  string $access_token 调用/oauth/client_token/生成的token，此token不需要用户授权。 (required)
     *
     * @throws swagger_client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \swagger_client\Model\PoiOrderSyncOrderSyncInlineResponse200, HTTP status code, HTTP response headers (array of strings)
     */
    public function poiOrderSyncPostWithHttpInfo($body, $access_token)
    {
        $returnType = '\swagger_client\Model\PoiOrderSyncOrderSyncInlineResponse200';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\swagger_client\Model\PoiOrderSyncOrderSyncInlineResponse200',
    ...
    /**
     * Operation poiOrderSyncPostAsync
     *
     * 订单同步
     *
     * @param  \swagger_client\Model\PoiOrderSyncOrderSyncBody $body (required)
     ...
     */
    public function poiOrderSyncPostAsync($body, $access_token)
    {
        return $this->poiOrderSyncPostAsyncWithHttpInfo($body, $access_token)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation poiOrderSyncPostAsyncWithHttpInfo
     *
     * 订单同步
     *
     * @param  \swagger_client\Model\PoiOrderSyncOrderSyncBody $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function poiOrderSyncPostAsyncWithHttpInfo($body, $access_token)
    {
        $returnType = '\swagger_client\Model\PoiOrderSyncOrderSyncInlineResponse200';
        $request = $this->poiOrderSyncPostRequest($body, $access_token);
