...
class ToutiaoVideoDataApi
{
     ...
     * 查询特定视频的视频信息
     *
     * @param  \swagger_client\Model\ToutiaoVideoDataVideoDataBody $body body (required)
     ...
     * @return \swagger_client\Model\ToutiaoVideoDataVideoDataInlineResponse200
     */
     ...
     * 查询特定视频的视频信息
     *
     * @param  \swagger_client\Model\ToutiaoVideoDataVideoDataBody $body (required)
     * @param  string $open_id 通过/oauth/access_token/获取，用户唯一标志 (required)
     * @param  string $access_token 调用/oauth/access_token/生成的token，此token需要用户授权。 (required)
     *
     * @throws swagger_client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \swagger_client\Model\ToutiaoVideoDataVideoDataInlineResponse200, HTTP status code, HTTP response headers (array of strings)
     */
    public function toutiaoVideoDataPostWithHttpInfo($body, $open_id, $access_token)
    {
        $returnType = '\swagger_client\Model\ToutiaoVideoDataVideoDataInlineResponse200';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\swagger_client\Model\ToutiaoVideoDataVideoDataInlineResponse200',
    ...
    /**
     * Operation toutiaoVideoDataPostAsync
     *
     * 查询特定视频的视频信息
     *
     * @param  \swagger_client\Model\ToutiaoVideoDataVideoDataBody $body (required)
     ...
     */
    public function toutiaoVideoDataPostAsync($body, $open_id, $access_token)
    {
        return $this->toutiaoVideoDataPostAsyncWithHttpInfo($body, $open_id, $access_token)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation toutiaoVideoDataPostAsyncWithHttpInfo
     *
     * 查询特定视频的视频信息
     *
     * @param  \swagger_client\Model\ToutiaoVideoDataVideoDataBody $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function toutiaoVideoDataPostAsyncWithHttpInfo($body, $open_id, $access_token)
    {
        $returnType = '\swagger_client\Model\ToutiaoVideoDataVideoDataInlineResponse200';
        $request = $this->toutiaoVideoDataPostRequest($body, $open_id, $access_token);
