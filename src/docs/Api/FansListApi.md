...
# **fansListGet**
> \swagger_client\Model\UserFansFansInlineResponse200 fansListGet($open_id, $access_token, $count, $cursor)
...
[**\swagger_client\Model\UserFansFansInlineResponse200**](../Model/UserFansFansInlineResponse200.md)
